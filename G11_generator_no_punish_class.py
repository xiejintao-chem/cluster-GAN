...
def Punishment(geom,generator,flag=1):
	if flag==1:
		thresh1 = generator.info.thresh1 #smaller
		thresh2 = generator.info.thresh2 #larger
		w1      = generator.w1
		w2      = generator.w2
...
#		print(geom)	
	...
	if flag==2:
		rand_std   = generator.rand_std
		gen_tensor = generator.gen_tensor
		gen_std    = torch.std(gen_tensor)
		return abs(gen_std-rand_std)	
...
#		print(out.shape)
	...
	def train(self,discriminator,target_flag,maxit=1000):
		...
		for i in range(maxit):
			...
			punish  = Punishment(gen_tensor.detach(),self,flag=2) #LQNOTE look here. change flag if necessary 	
		#	print(punish)	
